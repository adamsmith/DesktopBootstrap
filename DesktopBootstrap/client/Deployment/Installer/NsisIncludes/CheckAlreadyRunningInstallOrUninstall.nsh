...
Function CheckAlreadyRunningInstallOrUninstall
	System::Call 'kernel32::CreateMutex(i 0, i 0, t "DesktopBootstrapSetup") ?e'
  Pop $R0
  ${If} $R0 != 0
		${Debug} "Already running install or uninstall detected.  Quiting after telling the user..."
  	MessageBox MB_OK|MB_ICONINFORMATION "An installation or uninstallation of DesktopBootstrap is already running.  Setup will now exit."
  	Quit
  ${EndIf}
FunctionEnd
